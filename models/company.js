...
class Company {
   ...
   * @param {string} filters.name - Company name must contain this string.
   * @param {number} filters.minEmployees - Company must have at least this number of employees.
   * @param {number} filters.maxEmployees - Company must have no more than this number of employees.
   *
